...
class AircraftEngineParams:
    ...
    ENGINE PARAMETERS
    -------------------------------------
    (14) ff_idle_sls        Fuel mass flow rate under engine idle and sea level static conditions, summed over
                            all engines, [:math:`kg s^{-1}`]
    (15) m_des              Design optimum Mach number where the fuel mass flow rate is at a minimum.
    (16) c_t_des            Design optimum engine thrust coefficient where the fuel mass flow rate is at a minimum.
    (17) eta_1              Multiplier for maximum overall propulsion efficiency model
    (18) eta_2              Exponent for maximum overall propulsion efficiency model

    -------------------------------------
    OPERATIONAL PARAMETERS
    -------------------------------------
    (19) amass_mtow         Aircraft maximum take-off weight, [:math:`kg`]
    (20) amass_mlw          Aircraft maximum landing weight, [:math:`kg`]
    (21) amass_mzfw         Aircraft maximum zero fuel weight, [:math:`kg`]
    (22) amass_oew          Aircraft operating empty weight, [:math:`kg`]
    (23) amass_mpl          Aircraft maximum payload, [:math:`kg`]
    (24) max_altitude_ft    Maximum altitude, [:math:`ft`]
    (25) max_mach_num       Maximum operational Mach number
    (26) wingspan           Aircraft wingspan, [:math:`m`]
    (27) fuselage_width     Aircraft fuselage width, [:math:`m`]
    """

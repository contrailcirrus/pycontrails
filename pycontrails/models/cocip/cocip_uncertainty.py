...
class CocipUncertaintyParams(CocipParams):
    ...
    #: Schumann takes ``initial_wake_vortex_depth`` = 0.5 and discusses some uncertainty in this value
    #: This parameter should NOT be negative.
    ...
    #: Table 2 in :cite:`schumannParametricRadiativeForcing2012` provides relative RMS error for SW/LW

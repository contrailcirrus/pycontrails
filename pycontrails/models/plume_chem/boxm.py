...
class BoxModel(Model):
    ...
    def eval(
        ...
        **params : Any
        ...
        self.met.data = self.met.data.interp_like(self.chem.data)
    ...
    def _chemco(self, ts):
        ...
        print(chem["RC"].data.loc[0, 0, met["level"].data[8].values, ts, 1].values)
    ...
    def calc_aerosol(self, ts):
        ...
        self.chem["soa"].data.loc[:, :, :, ts] = Y.sel(species='P2604') * 3.574E-10 + Y.sel(species='P4608') * 3.574E-10 + Y.sel(species='P2631') * 3.059E-10 + \
            + Y.sel(species='P4610') * 3.093E-10 + Y.sel(species='P2605') * 3.093E-10 + Y.sel(species='P2630') * 3.325E-10 + \
            + Y.sel(species='P2629') * 4.072E-10 + Y.sel(species='P2632') * 2.860E-10 + Y.sel(species='P2637') * 3.391E-10 + \
            + Y.sel(species='P3612') * 2.310E-10 + Y.sel(species='P3613') * 2.543E-10 + Y.sel(species='P3442') * 1.628E-10 + \
            + Y.sel(species='P2007') * 2.493E-10
